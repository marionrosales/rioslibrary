   ...
   <div class="panel panel-default" ng-show="register_form">
    ...
    <div class="panel-body">
     <form method="post" ng-submit="submitRegister()">
      <div class="form-group">
       <label>Name</label>
       <input type="text" name="email" ng-model="registerData.name" class="form-control" />
      </div>
      <div class="form-group">
       <label>Address</label>
      ...
      <div class="form-group">
       ...
       <input type="text" name="contact" ng-model="registerData.contact" class="form-control" />
      </div>
      <div class="form-group">
       <label>Username</label>
       <input type="text" name="name" ng-model="registerData.username" class="form-control" />
      </div>
      <div class="form-group">
       <label>Password</label>
